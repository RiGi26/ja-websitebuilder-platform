...
const FINEDINING: ComposableContent = {
  nama: 'Meja Nusantara',
  hero: {
    eyebrow: 'Fine Dining Nusantara · Senopati, Jakarta',
    title: 'Masakan Warisan, Disajikan Selayak Perayaan',
    subtitle:
  ...
  featuresTitle: 'Pengalaman, bukan sekadar santapan',
  featuresSubtitle: 'Tiga hal yang kami jaga di setiap kunjungan Anda.',
  features: [
    { title: 'Dapur Dipimpin Chef', desc: 'Chef Anindya dan tim mengolah tiap pesanan à la minute — bukan masakan tunggu yang dihangatkan.' },
    { title: 'Bahan Diburu Tiap Pagi', desc: 'Ikan dari pelelangan, rempah dari pasar, sayur dari petani mitra. Dipilih hari itu juga.' },
    { title: 'Untuk Momen Penting', desc: 'Lamaran, ulang tahun, jamuan klien — ruang semi-privat dan tim yang paham acara Anda.' },
  ],
  statement: {
    eyebrow: 'Filosofi Dapur',
    quote: 'Kami tidak menemukan ulang masakan Indonesia. Kami merawatnya — satu resep warisan, satu bahan terbaik, satu piring pada satu waktu.',
    cite: 'Chef Anindya Larasati · Kepala Dapur',
  },
  showcase: {
    title: 'Menu Pilihan',
    subtitle: 'Sebagian dari menu kami. Daftar lengkap tersedia di meja.',
    items: [
      ...
      { nama: 'Wedang Rempah Hangat', harga: 28000, desc: 'Jahe, sereh, kayu manis. Penutup yang menenangkan.', kategori: 'Minuman' },
      { nama: 'Es Markisa Madu', harga: 30000, desc: 'Markisa segar, sedikit madu, tanpa pemanis buatan.', kategori: 'Minuman' },
    ],
  },
  stats: [
    { angka: '2010', label: 'Berdiri sejak' },
    { angka: '4.9', label: 'Rating 1.200+ ulasan' },
    { angka: '8', label: 'Ruang semi-privat' },
    { angka: '120', label: 'Kapasitas tamu' },
  ],
  testimonials: [
    { quote: 'Kami rayakan ulang tahun pernikahan ke-25 di ruang privat. Tim mengingat nama kami, dan hidangannya membuat malam itu tak terlupakan.', nama: 'Bp. & Ibu Wijaya', peran: 'Tamu sejak 2014' },
  ...
  faq: [
    ...
    { q: 'Apakah ada pilihan tanpa daging?', a: 'Ada beberapa hidangan sayur dan seafood. Beri tahu kami pantangan atau alergi saat memesan — dapur akan menyesuaikan.' },
    { q: 'Apakah tersedia parkir?', a: 'Tersedia valet setiap malam dan area parkir untuk tamu di belakang gedung.' },
  ],
  info: {
    jam: [
    ...
    telp: '081296917963',
    reservasiText: 'Reservasi via WhatsApp',
    reservasiHref: '#wa',
  },
  about: {
    title: 'Tentang Meja Nusantara',
    body: 'Berawal dari meja makan keluarga di Jakarta pada 2010, Meja Nusantara lahir dari satu keyakinan: masakan Indonesia layak disajikan dengan kehormatan yang sama seperti masakan dunia mana pun.\n\nKini kami memuliakan resep dari Aceh hingga Bali — diolah chef yang menghormati pakem, dengan bahan yang kami buru tiap pagi. Setiap piring membawa cerita; setiap kunjungan, sebuah perayaan kecil.',
  },
  cta: {
    title: 'Meja terbaik cepat penuh',
    subtitle: 'Akhir pekan biasanya penuh dipesan. Amankan malam Anda sekarang.',
    ctaText: 'Reservasi via WhatsApp',
    ctaHref: '#wa',
  },
