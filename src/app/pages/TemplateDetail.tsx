  ...
  const reviews = [
    {
      ...
      role: "Pemilik Kafe",
      rating: 5,
      comment: "Website-nya keren banget! Pelanggan jadi lebih mudah lihat menu dan lokasi kami.",
      avatar: "BS"
    },
    {
      name: "Siti Nurhaliza",
      role: "Owner Butik",
      rating: 5,
      comment: "Proses cepat, hasilnya profesional. Sangat recommended!",
      avatar: "SN"
    }
  ];
            ...
            <div className="bg-gray-100 rounded-lg p-8 flex items-center justify-center min-h-[600px]">
              <div
                className={`bg-white rounded-lg shadow-xl transition-all duration-300 ${
                  ...
                  device === "tablet" ? "w-2/3 aspect-[4/3]" :
                  "w-1/3 aspect-[9/16]"
                }`}
              >
            ...
            <div className="mt-8 bg-gray-50 rounded-lg p-6">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span className="ml-2 font-medium">React + Tailwind</span>
                </div>
                <div>
                  <span className="text-gray-500">Halaman:</span>
                  <span className="ml-2 font-medium">5 halaman</span>
                </div>
                <div>
                  <span className="text-gray-500">Update:</span>
                  <span className="ml-2 font-medium">Gratis 6 bulan</span>
                </div>
                <div>
            ...
            <div className="sticky top-24 bg-white border rounded-lg p-6 shadow-sm">
              ...
              <div className="space-y-3 mb-6">
                <Button asChild className="w-full bg-black hover:bg-gray-800">
                  <Link to="/order">Pilih Template Ini</Link>
                </Button>
              ...
              <div className="text-center">
                ...
                <Link to="/order" className="text-sm text-purple-600 hover:underline font-medium">
