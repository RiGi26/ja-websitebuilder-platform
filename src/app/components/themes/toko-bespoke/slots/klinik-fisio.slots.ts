...
export const KLINIK_FISIO_SLOTS: ThemeSlotManifest = {
  ...
  fields: [
    ...
    // ── Hero & Badge ──
    { key: 'copy.hero_tagline', type: 'text', label: 'Pil tagline hero', group: 'Hero & Badge', max: 60, default: 'Siap gerak bebas tanpa khawatir?', hint: 'Dipakai bila konten hero tidak menyetel teks tombol keduanya.' },
    ...
    { key: 'copy.keluhan_title', type: 'text', label: 'Judul bagian keluhan', group: 'Judul Bagian', max: 80, default: 'Nyeri yang bikin kamu berhenti bergerak?' },
    { key: 'copy.keluhan_sub', type: 'text', label: 'Subjudul bagian keluhan', group: 'Judul Bagian', max: 120, default: 'Kami bantu cari sumbernya, bukan cuma redakan sementara.' },
    ...
    { key: 'copy.steps_eyebrow', type: 'text', label: 'Label kecil jalur pemulihan', group: 'Judul Bagian', max: 40, default: 'Cara kerja' },
    { key: 'copy.steps_title', type: 'text', label: 'Judul jalur pemulihan', group: 'Judul Bagian', max: 60, default: 'Jalur pemulihan dalam tiga langkah' },
    { key: 'copy.layanan_eyebrow', type: 'text', label: 'Label kecil bagian layanan', group: 'Judul Bagian', max: 40, default: 'Layanan' },
    ...
    { key: 'copy.ulasan_eyebrow', type: 'text', label: 'Label kecil bagian ulasan', group: 'Judul Bagian', max: 40, default: 'Cerita pasien' },
    { key: 'copy.ulasan_title', type: 'text', label: 'Judul bagian ulasan', group: 'Judul Bagian', max: 60, default: 'Mereka kembali bergerak bebas' },
    { key: 'copy.faq_eyebrow', type: 'text', label: 'Label kecil bagian FAQ', group: 'Judul Bagian', max: 40, default: 'FAQ' },
    { key: 'copy.faq_title', type: 'text', label: 'Judul bagian FAQ', group: 'Judul Bagian', max: 60, default: 'Pertanyaan yang sering ditanyakan' },
