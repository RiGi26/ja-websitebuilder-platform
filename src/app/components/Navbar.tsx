...
const CORP_URL = import.meta.env.VITE_CORP_URL ?? "https://japanarenacorp.com";
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link to="/portfolio" className="text-sm hover:text-gray-600 transition-colors">
            Template
          </Link>
          <Link to="/portfolio" className="text-sm hover:text-gray-600 transition-colors">
            Portofolio
        ...
        {/* CTA Button */}
        <Button asChild>
          <Link to="/order">Mulai Gratis</Link>
        </Button>
      </div>
    </nav>
  );
